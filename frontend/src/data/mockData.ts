...
export const newsData = [
  ...
  },
  {
    ...
    date: "April 2, 2026",
    summary:
      "The latest iteration of the Starship vehicle completed a flawless orbital flight and precision landing, paving the way for future Mars missions.",
    image: "https://picsum.photos/seed/rocket/600/400",
    category: "Technology",
  },
  {
    id: 3,
    title: "Artemis Base Camp Construction Begins",
    date: "March 28, 2026",
    summary:
      "International partners have officially started deploying the first modules for the permanent human settlement at the lunar south pole.",
    image: "https://picsum.photos/seed/moon/600/400",
    category: "Exploration",
  },
  {
    id: 4,
    title: "Uzbekistan Announces New Space Agency Initiative",
    date: "March 15, 2026",
    summary:
      "A new program aimed at funding student research in astrophysics and satellite technology has been launched in Tashkent.",
    image: "https://picsum.photos/seed/tashkent/600/400",
    category: "Local",
  },
  {
    id: 5,
    ...
    date: "March 10, 2026",
    summary:
      "Scientists have achieved a sustained fusion reaction that could potentially cut travel time to Mars in half.",
