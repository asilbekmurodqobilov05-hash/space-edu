...
const CATEGORIES = [
  {
    id: "physics",
    title: "Physics",
    description: "Test your knowledge of the fundamental laws of nature.",
    icon: Atom,
    color: "#a78bfa",
  ...
  },
  {
    id: "astronomy",
    title: "Astronomy",
    description: "Journey through the stars and explore the cosmos.",
    icon: Rocket,
    color: "#60a5fa",
  ...
  },
  {
    id: "problems",
    title: "Problems",
    description: "Challenge yourself with complex physics and math problems.",
    icon: Brain,
    color: "#f472b6",
  ...
  },
  {
    ...
    description: "Assess your learning progress from our digital academies.",
    icon: MonitorPlay,
    color: "#34d399",
      ...
      <div className="w-full max-w-6xl">
        ...
        >
          ...
          <p className="mt-4 text-lg text-white/60 max-w-2xl mx-auto">
            Select a category below to start your timed challenge. Each quiz contains 30 questions designed to test your limits.
          </p>
        </motion.div>
            ...
            return (
              <Link key={cat.id} to={`/quiz/${cat.id}`} className="block w-full h-full">
                ...
                >
                  ...
                  <h2 className="text-3xl font-bold text-white mb-3 tracking-wide">{cat.title}</h2>
                  <p className="text-white/60 text-sm md:text-base max-w-[80%]">{cat.description}</p>
