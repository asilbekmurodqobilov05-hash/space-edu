          ...
          return (
            ...
            >
              <div className="relative h-36">
                <img
                  src={item.image}
                  alt={t('market', item.nameKey as any)}
              ...
              <div className="p-4 flex flex-col flex-1 gap-3">
                <div>
                  <h2 className="text-lg font-bold text-white">{t('market', item.nameKey as any)}</h2>
                  <p className="text-white/60 text-sm mt-1 leading-snug">{t('market', item.descKey as any)}</p>
                </div>
