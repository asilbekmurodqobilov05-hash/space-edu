...
import { careersData, roadmapSteps, careerQuizQuestions, CareerPath } from '@/data/careersData';
...
export default function CareersView() {
  ...
  const handleQuizAnswer = (careerId: string) => {
  ...
  const handleEnlist = (careerId: string) => {
      ...
      <div className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {careersData.map((career) => {
            const Icon = iconMap[career.icon as keyof typeof iconMap] || Briefcase;
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-neon-purple/20 text-neon-purple rounded-xl">
                    {(() => {
                      const Icon = iconMap[selectedCareer.icon as keyof typeof iconMap] || Briefcase;
